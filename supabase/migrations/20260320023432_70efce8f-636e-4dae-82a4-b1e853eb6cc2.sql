...
-- Fix email_on_new_message: add purpose field
...
-- Fix email_on_payment: add purpose field
...
-- Fix email_on_project_update: add purpose field
...
BEGIN
  ...
  PERFORM public.enqueue_email(
    ...
    jsonb_build_object(
      ...
      'subject', _subject,
      'html', _html,
      'text', 'Hi ' || COALESCE(_client_name, 'there') || ', your project "' || NEW.name || '" has been updated.',
      'purpose', 'transactional',
